...
public class ExperimentManager : MonoBehaviour
{
    ...
    [Header("Trial Params")]
    public string csvFileHeader = "witlab";
    ...
    public void OnTargetSelected(int hitIndex, Vector2 hitPos2D)
    {
        ...
        if (endIdx >= 0 && endIdx < spawner.spawnedTargets.Count)
        {
            var tgt = spawner.spawnedTargets[endIdx].transform.position;
            targetPos2D = new Vector2(tgt.x, tgt.y);
        }
